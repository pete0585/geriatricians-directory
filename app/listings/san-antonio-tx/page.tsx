...
export const metadata: Metadata = {
  title: "Best Geriatrician in San Antonio, TX | Geriatrician Directory",
  description: "Find geriatrician in San Antonio, Texas. 38+ listed. Filter by city and compare providers.",
}
...
export default async function CityPage() {
  ...
  const faqLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many geriatrician are in San Antonio, TX?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Geriatrician Directory lists 38+ geriatrician in San Antonio, Texas. Counts change as new listings are seeded.",
        },
      },
      {
        "@type": "Question",
        name: "How do I find geriatrician in San Antonio?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Search geriatriciandirectory.com and filter by San Antonio. Compare listed providers, then contact the one that fits.",
        },
      },
    ],
  }
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">
          Geriatrician in San Antonio, TX
        </h1>
        <p className="mt-3 max-w-2xl text-neutral-600">
          38+ listed geriatrician in the San Antonio area. Pages are generated from live directory listings — not outreach.
        </p>
