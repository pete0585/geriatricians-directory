...
export const metadata = cityPageMetadata(
  "philadelphia-pa",
  "Best Geriatrician in Philadelphia, PA | Geriatrician Directory",
  "Find geriatrician in Philadelphia, Pennsylvania. 37+ listed. Filter by city and compare providers.",
)
