...
export const metadata: Metadata = {
  title: "Best Geriatrician in New York, NY | Geriatrician Directory",
  description: "Find geriatrician in New York, New York. 44+ listed. Filter by city and compare providers.",
}
...
export default async function CityPage() {
  ...
  const faqLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many geriatrician are in New York, NY?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Geriatrician Directory lists 44+ geriatrician in New York, New York. Counts change as new listings are seeded.",
        },
      },
      {
        "@type": "Question",
        name: "How do I find geriatrician in New York?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Search geriatriciandirectory.com and filter by New York. Compare listed providers, then contact the one that fits.",
        },
      },
    ],
  }
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">
          Geriatrician in New York, NY
        </h1>
        <p className="mt-3 max-w-2xl text-neutral-600">
          44+ listed geriatrician in the New York area. Pages are generated from live directory listings — not outreach.
        </p>
