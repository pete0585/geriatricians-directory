...
const NICHE = 'geriatrics' as const
const DIRECTORY_SLUG = 'geriatricians-directory' as const
const NEWSLETTER_NAME = 'Later-Life Fieldnotes' as const
const CONFIRM_URL_BASE = 'https://www.geriatriciandirectory.com/newsletter/confirm'
